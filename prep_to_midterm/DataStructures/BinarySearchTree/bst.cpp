#include <iostream>
using namespace std;
// A Binary Search Tree (or BST) is a data structure where each node has at most two children, a left child and a right child, 
...
// Time Complexity: Search, Insertion, Deleting: Best case (Balanced): O(log n)
