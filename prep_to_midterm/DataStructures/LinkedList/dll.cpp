#include<iostream>
using  namespace std;
// A doubly linked list is a linear data structure similar to a singly linked list, but each node contains an additional pointer. 
// Each node stores a data and pointer for the next and for the previous node.
// Time Complexity of operations:
// Access (by index): O(n), Search for an Element: O(n)
// Insert at Beginning: O(1), Insert at End: O(1), Insert at Middle: O(n)
// Delete from Beginning: O(1), Delete from End: O(1)
